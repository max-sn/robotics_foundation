...
This module contains numerical implementations, using `numpy <https://numpy.org/>`_. These implementations are the default when using ``from modern_robotics import *``. They can be loaded specifically by using ``from modern_robotics.num import *``.
